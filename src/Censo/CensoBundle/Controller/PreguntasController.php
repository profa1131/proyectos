...
use Censo\CensoBundle\Entity\Preguntas;
use Censo\CensoBundle\Form\PreguntasType;
...
class PreguntasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CensoBundle:Preguntas')->findAll();
     ...
     * @Method("POST")
     * @Template("CensoBundle:Preguntas:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CensoBundle:Preguntas')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CensoBundle:Preguntas:edit.html.twig")
     */
