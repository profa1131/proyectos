...
class Enseres
{
     ...
     * @ORM\SequenceGenerator(sequenceName="enseres_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     *
     * @ORM\ManyToMany(targetEntity="RegistroSocioeconomico", mappedBy="enseres")
     */
